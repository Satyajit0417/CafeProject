		...
		<form action="../EmployeeReport" method="post">
			...
			<div class="row mt-3">
				...
				<div class="col-md-2">
					<div class="mb-2">
						<center>
							<input type="submit" class="btn btn-primary" value="Employees" name="tiktok">
						</center>
					</div>
				</div>
				<div class="col-md-2">
					<div class="mb-2">
						<center>
							<input type="submit" class="btn btn-primary" value="Users" name="tiktok">
						</center>
					</div>
				</div>
				<div class="col-md-2">
					<div class="mb-2">
						<center>
							<input type="submit" class="btn btn-primary" value="Feedbacks" name="tiktok">
						</center>
					</div>
				</div>
				<div class="col-md-3"></div>
